  ...
  return (
    <Overlay>
      ...
      <div className="mt-4 space-y-3 text-sm leading-relaxed text-[#c9c0b0]">
        ...
        <p><b className="text-[#c9a227]">Interview.</b> Press <b>E</b> near a guest. Time pauses. You get four questions at a time — timelines, suspicions, rumors, alibis. Answers change as word spreads through the house.</p>
